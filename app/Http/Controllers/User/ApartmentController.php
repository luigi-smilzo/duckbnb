...
class ApartmentController extends Controller
{
    ...
    {
        $apartments = Apartment::where('user_id', Auth::id())->orderBy('id', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        if ($saved) {
            ...
            // Mail::to(Auth::user()->email)->send(new NewApartment($newApartment)); <--- Disabled to increase development network performances
    ...
    public function show(Apartment $apartment)
    {
        ...
        return view('guests.show', compact('apartment', 'is_sponsored'));
    }
    ...
    public function update(Request $request, Apartment $apartment)
    {
        ...
        if ($updated) {
            ...
            // Mail::to(Auth::user()->email)->send(new EditApartment($apartment)); <--- Disabled to increase development network performances
    ...
    public function destroy(Apartment $apartment)
    {
        ...
        if ($deleted) {
            ...
            // Mail::to(Auth::user()->email)->send(new DeleteApartment($apartment)); <--- Disabled to increase development network performances
    ...
    private function validationRules($type = "")
    {
        ...
        return [
            ...
            "room_qty" => "required|integer|min:1|max:255",
            "bathroom_qty" => "required|integer|min:1|max:255",
            "bed_qty" => "required|integer|min:1|max:255",
            "sqr_meters" => "required|integer|min:30|max:65535",
